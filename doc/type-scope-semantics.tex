...
\begin{figure}[h]
\ExecuteMetaData[type-scope-semantics/StateOfTheArt/McBride05/Base.tex]{ren}
\ExecuteMetaData[type-scope-semantics/StateOfTheArt/McBride05/Base.tex]{sub}
...
\begin{minipage}{0.35\textwidth}
  \ExecuteMetaData[type-scope-semantics/StateOfTheArt/McBride05/Kit.tex]{renkit}
\end{minipage}
\begin{minipage}{0.65\textwidth}
  \ExecuteMetaData[type-scope-semantics/StateOfTheArt/McBride05/Kit.tex]{ren}
\end{minipage}
...
\begin{figure}[h]
\begin{minipage}{0.35\textwidth}
  \ExecuteMetaData[type-scope-semantics/StateOfTheArt/McBride05/Kit.tex]{subkit}
\end{minipage}
\begin{minipage}{0.65\textwidth}
  \ExecuteMetaData[type-scope-semantics/StateOfTheArt/McBride05/Kit.tex]{sub}
\end{minipage}
...
\begin{figure}[h]
\ExecuteMetaData[type-scope-semantics/Semantics/Syntactic/Specification.tex]{syntactic}
\ExecuteMetaData[type-scope-semantics/Semantics/Syntactic/Specification.tex]{syntacticsem}
...
\begin{figure}[h]
\ExecuteMetaData[type-scope-semantics/Semantics/Syntactic/Instances.tex]{synren}
\ExecuteMetaData[type-scope-semantics/Semantics/Syntactic/Instances.tex]{ren}
...
\begin{figure}[h]
\ExecuteMetaData[type-scope-semantics/Semantics/Syntactic/Instances.tex]{synsub}
\ExecuteMetaData[type-scope-semantics/Semantics/Syntactic/Instances.tex]{sub}
...
\begin{figure}[h]
\begin{minipage}{0.5\textwidth}
\ExecuteMetaData[type-scope-semantics/Semantics/Printing.tex]{name}
\end{minipage}
\begin{minipage}{0.5\textwidth}
\ExecuteMetaData[type-scope-semantics/Semantics/Printing.tex]{printer}
\end{minipage}

\ExecuteMetaData[type-scope-semantics/Semantics/Printing.tex]{printing}
\caption{Printing with Names as \AR{Semantics}\label{fig:semprint}}
\end{figure}
...
\begin{figure}[h]
\ExecuteMetaData[type-scope-semantics/Semantics/Printing.tex]{print}
...
\begin{figure}[h]
\ExecuteMetaData[type-scope-semantics/Semantics/Printing.tex]{test}
