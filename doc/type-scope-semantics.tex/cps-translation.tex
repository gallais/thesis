...
and \AIC{`bind} which correpond to the \AIC{\#} monad in Moggi's ML and are
...
continuation and applies to its translated argument (\AF{cps} \AB{t}).
...
fact that in both translation the translation of a function's domain is uniform.
