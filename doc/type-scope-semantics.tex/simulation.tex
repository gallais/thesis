...
arising from a \AR{Syntactic} (cf.~\cref{syntactic}) definition are extensional. We
...
\ExecuteMetaData[type-scope-semantics.agda/Properties/Simulation/Instances.tex]{eval}\todo{add eval}
