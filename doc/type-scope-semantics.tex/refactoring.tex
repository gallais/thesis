...
propagate the appropriate constraints. We also call \AF{Fresh} the state monad
threading the name supply which is essentially a stream of distinct strings.
