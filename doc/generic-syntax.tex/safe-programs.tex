...
then implement \AF{reify} as in Figure~\ref{fig:kripkereify} turning
\AF{Kripke} function spaces from \AB{𝓥} to \AB{𝓒} into \AF{Scope}s of
\AB{𝓒} computations.
...
\input{generic-syntax.tex/catalogue/desugaring}
\input{generic-syntax.tex/catalogue/inlining}
