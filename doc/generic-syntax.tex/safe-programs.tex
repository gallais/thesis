...
descriptions as a semantics with \AF{Var} as values and \AD{Tm} as computations. The
first two constraints on \AF{Var} described earlier are trivially satisfied. Observing
...
Substitution is defined in a similar manner with \AD{Tm} as both values and computations.
...
The reification process mentioned in the definition of renaming and substitution
can be implemented generically for \AR{Semantics} families which have \AR{VarLike}
values (\AF{vl\textsuperscript{Var}} and \AF{vl\textsuperscript{Tm}} are proofs of
