...
Agda also supports record types; they are defined by their set of fields.
...
fields are. Defining a record type also results in the definition of a
parameterised module containing a projection function for each field.
...
then its content. We use postfix projections.
